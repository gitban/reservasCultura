...
// $Id: mrbs.css.php 2217 2011-12-29 17:14:25Z cimorrison $
...
div#contents {padding: 0em}
div.trailer {padding: 2 0em}

h1 {font-size: x-large; clear: both}
h2 {font-size: large; clear: both; align:center}

img {border: 0}

a:link    {color: #003B72<?php //echo $anchor_link_color ?>;    text-decoration: none; font-weight: bold}	/* link */
a:visited {color: #003B72 <?php //echo $anchor_visited_color ?>; text-decoration: none; font-weight: bold} /* link seleccionado*/
a:hover   {color:#01294E<?php //echo $anchor_hover_color ?>;   text-decoration:none; font-weight: bold} /* link seleccionado*/
...
div#dwm_header {width: 100%; float: left}
div#dwm_rooms{
				margin:0px;
...
div#dwm_rooms li:hover{
				...
				-webkit-box-shadow: -5px 10px 15px rgba(0, 0.15, 0, 0.25);
...
#dwm_header h3 {font-size: small; font-weight: normal; text-decoration: none; 
    margin-top: 0; margin-bottom: 0.5em; padding-bottom: 0;  text-align:center;}

#dwm_header h5 {color: #047794;
				clear:both;
				float: right;
				font-size: 1.2em; 
				font-weight: normal; 
...
table.dwm_main {clear: both; width: 100%; border-spacing: 2px; border-collapse: separate;
...
.dwm_main#week_main th {
						width: <?php echo $column_week ?>%;
						color:red!important}
.dwm_main#week_main th.first_last {
									width: <?php echo $column_row_labels_width ?>%; 
...
div.cell_header {
				padding: 5px;
				color:red;
				position: relative; width: 100%; z-index: 20;         /* needs to be above the new booking anchor */
...
.dwm_main#month_main td:hover.valid, .dwm_main#month_main td.valid_hover {
																			background-color: cyan;/* <?php echo $row_highlight_color ?>*/;
																			-webkit-transition-duration: 0.8s;
																			-moz-transition-duration: 0.8s;
																			-webkit-box-shadow: -5px 10px 15px rgba(0, 0.15, 0, 0.25);
																			box-shadow: -5px 10px 15px rgba(0, 0, 0, 0.25);
...
.celldiv a:hover{
				...
				-webkit-transition-duration: 0.8s;
				-moz-transition-duration: 0.8s;
				-webkit-box-shadow: -5px 10px 15px rgba(0, 0.15, 0, 0.15);
				box-shadow: -5px 10px 15px rgba(0, 0, 0, 0.15);
				-moz-box-shadow: -5px 10px 15px rgba(0, 0, 0, 0.15);
				box-shadow: -5px 10px 15px rgba(0, 0, 0, 0.15);
				position: relative;
				z-index: 10;
				behavior: url(pie.htc);
...
#banner td#company {font-size: small}
...
td#sticky_day {
				...
				background-color: <?php echo $dia_seleccionado_highlight_font_color ?>;
				font-size: 1.5em;
				color: white;
