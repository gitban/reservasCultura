      ...
      <div class="modal-content">
        <div class="modal-body">
          ...
          <div class="modal-footer">
            <input id="edit_entry_submit_save" class="btn btn-success" type="submit" name="save_button" value="guardar">
...
var select = document.getElementById('rooms');
  ...
  btn_send_mail.onclick = function () {
    $('#f_observaciones').val($('#observaciones').val());

    $('#f_salones').val($('#salas').text());
    $('#f_confirmado').val(1);
  }
