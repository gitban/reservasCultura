...
//require_once "reserva_confirmada_send.php";
...
// exit;
/*
   ENVÍO DE CORREO CON DATOS DE LA RESERVA==
*/

if($_POST['f_confirmado']=='1'){
require_once 'lib/PHPMailer/PHPMailerAutoload.php';
if( $_POST['confirmed'] == 1){
$estado = " Reserva Confirmada ";
} else {
  $estado = " Provisoria: queda pendiente el envío de planilla firmada / autorización de hs extras/ comprobante de pago";  
}
$cuerpo = "
<html>
<div>
<img style='width:600px' src='images/logosec.png'/>
</div>
<h1 style='color:blue'> Solicitud de reserva </h1>
<p><b> Salas: </b><br>" .$_POST['f_salones']." </p>
<p><b> Evento: </b><br>" .$_POST['name']." </p>
<p><b> Descripcion:</b><br>" .$_POST['description']." 
<p><b> Estado de confirmación: :</b><br>" .$estado."
<p><b> Fecha Inicio:</b><br>".$_POST['start_day']."/".$_POST['start_month']."/".$_POST['start_year']." - ".convertirSegundos($_POST['start_seconds'])."</p>
<p><b> Fecha Fin:</b><br>".$_POST['end_day']."/".$_POST['end_month']."/".$_POST['end_year']." - ".convertirSegundos($_POST['end_seconds'])."</p>
<p><b> Contacto:</b><br>".$_POST['f_contact']."</p>
<p><b> Telefono contacto:</b><br>".$_POST['f_contact_phone']."</p>
<p><b> Mail contacto:</b><br>".$_POST['f_contact_mail']."</p>
<p><b> Requerimientos de Mayordomía:</b><br>".$_POST['f_mayordomia']."</p>
<p><b> Requerimientos Audiovisuales:</b><br>".$_POST['f_audiovisuales']."</p>
<p><b> Reserva realizada por:</b><br>".ucfirst($_POST['create_by'])."</p>
<br>
<h3 style='color:red'>OBSERVACIONES:</h3>
<p>".$_POST['f_observaciones']."</p>
</html>";
...
$mail->Subject     	= "Reservas Sec Cult y Ext: Estado de la reserva";
$mail->From     	= "culturayextension@uns.edu.ar";
$mail->FromName 	= "Reserva de espacios CyE";
$mail->Body 		= $cuerpo;
$mail->AddAddress('culturayextension@uns.edu.ar',$_POST['f_contact'],"CyE - Estado de la Reserva ");
$mail->AddCC('estalej@gmail.com','Cultura y Extensión U.N.S.',"CyE - Estado de la Reserva");
if($_POST['f_audiovisuales']||$_POST['f_audiovisuales']!=""){
  $mail->AddCC('dmauns@gmail.com','Audiovisuales',"CyE Reserva Confirmada");
}
if(!$mail->Send()) {
