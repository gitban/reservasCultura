...
$cuerpo = "
<html>
<h1 style='color:blue'> Confirmacion de reserva </h1>
<h2> Se ha realizado una reserva para el siguiente evento: </h2>
<p> Evento:" .$_POST['name']." </p>
<h3> Descripcion:</h3>
<p>" .$_POST['description']." 
<h3> Datos:</h3> 
<p> Fecha Inicio:".$_POST['start_day']."/".$_POST['start_month']."/".$_POST['start_year']." - ".convertirSegundos($_POST['start_seconds'])."</p>
<p> Fecha Fin:".$_POST['end_day']."/".$_POST['end_month']."/".$_POST['end_year']." - ".convertirSegundos($_POST['end_seconds'])."</p>
<p> Contacto:".$_POST['f_contact']."</p>
<p> Telefono contacto:".$_POST['f_contact_phone']."</p>
<p> Mail contacto:".$_POST['f_contact_mail']."</p>
<p> Requerimientos de Mayordomía:".$_POST['f_mayordomia']."</p>
<p> Requerimientos Audiovisuales:".$_POST['f_audiovisuales']."</p>
<p> Reserva realizada por:".$_POST['create_by']."</p>
<br>
...
$mail->Subject     	= "Reservas Sec Cult y Ext: Estado de la reserva de espacios";
$mail->From     	= "culturayextension@uns.edu.ar";
$mail->FromName 	= "CyE Reserva de Espacios";
$mail->Body 		= $cuerpo;
//$mail->AddAddress($_POST['f_contact_mail'],$_POST['f_contact'],"CyE Reserva Confirmada");
$mail->AddAddress('culturayextension@uns.edu.ar','Cultura y Extensión U.N.S.',"CyE - Estado de la reserva de espacios");
if(!$mail->Send()) {
